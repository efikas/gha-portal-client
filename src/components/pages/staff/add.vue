                        ...
                        <div class="row even-row">
                            <div class="col-md-8">
                                <div class="form-group p-10">
                                    ...
                                    <div class="col-md-12">
                                        <textarea rows="4" class="form-control resize_vertical" id="text_area" placeholder="Home/Residential Address"></textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row even-row">
                            ...
                            <div class="col-xs-12 col-sm-6 col-md-3">
                                <div class="form-group p-10">
                                    ...
                                    <div class="col-md-12">
                                        <input type="text" class="form-control" id="pob" placeholder="Year of Last Promotion">
                                    </div>
                                </div>
                            </div>
                            <div class="col-xs-12 col-sm-6 col-md-3">
                                <div class="form-group p-10">
                                    ...
                                    <div class="col-md-12">
                                        <input type="text" class="form-control" name="" value=""  placeholder="Year of Posting">
                                    </div>
                                </div>
                            </div>
                            <div class="col-xs-12 col-sm-6 col-md-3">
