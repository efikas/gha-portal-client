                    ...
                    <div class="row even-row">
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-4">
                            <div class="form-group p-10">
                                ...
                                <div class="row">
                                    <div class="col-md-5">
                                        <input type="text" class="form-control" id="text" placeholder="e.g. 7.6408">
                                    </div>
                                    <div class="col-md-5">
                                        <input type="text" class="form-control" id="text" placeholder="e.g. 5.2031">
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row odd-row">
                        <div class="col-xs-12 col-sm-6 col-md-5">
                            <div class="form-group p-10">
                                ...
                                <div class="col-md-12">
                                    <input type="text" class="form-control" id="text" placeholder="Propritor Name">
                                </div>
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-6 col-md-3">
                            <div class="form-group p-10">
                                ...
                                <div class="col-md-12">
                                    <div class="radio">
                                        <b-form-radio name="p_membership" checked="false">
                                            Yes
                                        </b-form-radio>
                                    </div>
                                    <div class="radio" checked="false">
                                        <b-form-radio name="p_membership">
                                            No
                                        </b-form-radio>
                                    </div>
                                </div>
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-4">
                            <div class="form-group p-10">
                                ...
                                <div class="col-md-12">
                                    <input type="text" class="form-control" id="text" placeholder="PPrivate Memebership's Name">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row odd-row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group p-10">
                                ...
                                <div class="col-md-12">
                                    <input type="number" class="form-control" id="text" placeholder="Number of Inspections">
                                </div>
                            </div>
                        </div>
                        <div class="col-md-">
                    ...
                    <div class="row even-row">
                        <div class="col-md-6">
                            <div class="form-group p-10">
                                ...
                                <div class="col-md-12">
                                    <textarea rows="4" class="form-control resize_vertical" id="text_area" placeholder="School Address"></textarea>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
            ...
            <tab-content title="Additional Info" icon="fa fa-setting">
                <form method="" class="form-horizontal">
                    <div class="row odd-row">
                        <div class="col-xs-12 col-sm-6 col-md-3">
                            <div class="form-group p-10">
                                <label class="control-label col-md-12" for="text">Bording 
                                </label>
                                <div class="col-md-12">
                                    <div class="radio">
                                        <b-form-radio checked="false">
