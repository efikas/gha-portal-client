let XlsExport = {
    ...
    _data: null,
    _name: null,
    _XlsExport: function (data, title = 'Worksheet') {
    ...
    exportToXLS: function (data, fileName = 'export.xls', title = 'Worksheet') {
        this._XlsExport(data, title)
    ...
    exportToCSV: function (fileName = 'export.csv') {
        if (typeof fileName !== 'string' || Object.prototype.toString.call(fileName) !== '[object String]') {
            throw new Error('Invalid input type: exportToCSV(String)');
        }
    ...
    downloadFile: function (output, fileName) {
