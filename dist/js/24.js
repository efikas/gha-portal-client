...
var update = __webpack_require__(32)("d180bc4a", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../../node_modules/css-loader/index.js!../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-855676a2\",\"scoped\":true,\"hasInlineConfig\":true}!../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./import.vue", function() {
     var newContent = require("!!../../../../node_modules/css-loader/index.js!../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-855676a2\",\"scoped\":true,\"hasInlineConfig\":true}!../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./import.vue");
...
// module
exports.push([module.i, "\n.dz-progress[data-v-855676a2]{\n       background-color: #08aa80 !important;\n}\ninput[type=\"file\"][data-v-855676a2]{\n   position: absolute;\n   top: -500px;\n}\ndiv.upload[data-v-855676a2]{\n   width: 400px;\n   cursor: pointer;\n   height: 100px;\n   background-color: indianred;\n   text-align: center;\n   font-weight: bold;\n   color: whitesmoke;\n   padding-top: 30px;\n   font-size: 1.2em;\n}\n", ""]);
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(32)("6b118966", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../css-loader/index.js!../../vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-855676a2\",\"scoped\":false,\"hasInlineConfig\":true}!./vue-multiselect.min.css", function() {
     var newContent = require("!!../../css-loader/index.js!../../vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-855676a2\",\"scoped\":false,\"hasInlineConfig\":true}!./vue-multiselect.min.css");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_vue_multiselect__ = __webpack_require__(999);
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        ...
        submitFile: function submitFile() {
            ...
            this.$staff.importStaff(this.schoolId, formData).then(function (response) {
                console.log('SUCCESS!!');
            }).catch(function () {
                console.log('FAILURE!!');
            });
        ...
        getSchoolId: function getSchoolId() {
            ...
            var _selectedSchool = this.allSchools.filter(function (school) {
                return school.name == _this2.school_name;
            });
    ...
    mounted: function mounted() {
        ...
        if (settings) {
            ...
            settings.lga_areas.forEach(function (item) {
                _this3.lgasInfo.push(item);
                _this3.lgas.push(item.name);
            });
        }

        //get list of schools
        this.$school.allSchools().then(function (data) {
            _this3.allSchools = data.data;
        });
    },
    ...
    watch: {
        allSchools: function allSchools(value) {
            ...
            value.forEach(function (school) {
                _this4.schools.push(school.name);
            });
            ...
            var _school = value.filter(function (school) {
                return school.id == _this4.data.school_id;
            });
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-855676a2", module.exports)
  }
}
...
/* script */
var __vue_script__ = __webpack_require__(1460)
/* template */
...
/* scopeId */
var __vue_scopeId__ = "data-v-855676a2"
...
Component.options.__file = "src/components/pages/staff/import.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-855676a2", Component.options)
  } else {
    hotAPI.reload("data-v-855676a2", Component.options)
  }
