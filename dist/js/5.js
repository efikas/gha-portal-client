...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    computed: Object(__WEBPACK_IMPORTED_MODULE_1_vuex__["b" /* mapGetters */])(['students', 'school']),
    watch: {
    ...
    methods: {
        deleteRecord: function deleteRecord(id) {
            ...
            if (confirm('Deleting this item will remove all it\'s related data! Are you sure you want to proceed?')) {
                this.$store.dispatch('deleteStudents', { ids: [id] }).then(function () {
        ...
        exportExcel: function exportExcel() {
            ...
            dummy.download = 'students-' + this.school.name.toLowerCase().replace(/ /g, '-') + '-' + d.getFullYear() + '-' + (d.getMonth() + 1) + '-' + d.getDate() + '-' + d.getHours() + '-' + d.getMinutes() + '-' + d.getSeconds() + '.xls';
            dummy.click();
        },
        renderTable: function renderTable() {
            var table = '<table><thead>' + '<tr>' + '<th>ID</th>' + '<th>LAST NAME</th>' + '<th>MIDDLE NAME</th>' + '<th>FIRST NAME</th>' + '<th>SEX</th>' + '<th>CLASS</th>' + '</tr></thead>';
            table += '<tbody>';
      ...
      [
        ...
        _c(
          "b-card",
          {
            ...
            attrs: { header: "List of Students", "header-tag": "h4" }
          },
          [
            _vm.loading
              ? _c(
                        ...
                        },
                        {
                          ...
                          fn: function(student) {
                            return _c("span", {}, [
                              _vm._v(
                                _vm._s(
                                  student.row.current_class
                                    ? student.row.current_class.class
                                    : null
                                )
                              )
                            ])
                            ...
                            return _c("div", {}, [
                              _c(
                                "a",
                                {
                                  ...
                                  on: {
                                    click: function($event) {
                                      _vm.deleteRecord(student.row.id)
                                    }
                                  }
                                },
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-22903f32", module.exports)
  }
}
...
Component.options.__file = "src/components/pages/student/students.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-22903f32", Component.options)
  } else {
    hotAPI.reload("data-v-22903f32", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
