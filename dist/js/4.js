...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(32)("4dadd1ad", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../../node_modules/css-loader/index.js!../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-4f40439d\",\"scoped\":true,\"hasInlineConfig\":true}!../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./staffs.vue", function() {
     var newContent = require("!!../../../../node_modules/css-loader/index.js!../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-4f40439d\",\"scoped\":true,\"hasInlineConfig\":true}!../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./staffs.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
...
// module
exports.push([module.i, "\n.sch-link[data-v-4f40439d] {\n    display: block;\n    padding: 3px;\n}\n.sch-link[data-v-4f40439d]:hover {\n    text-decoration: underline !important;\n}\n", ""]);
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__widgets_sbemis_SchoolCard1__ = __webpack_require__(1086);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__widgets_sbemis_SchoolCard1___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__widgets_sbemis_SchoolCard1__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_vuex__ = __webpack_require__(255);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__store_store__ = __webpack_require__(69);
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    components: {
        SchoolCard: __WEBPACK_IMPORTED_MODULE_0__widgets_sbemis_SchoolCard1___default.a
    },
    data: function data() {
        return {
            loading: true,
    ...
    computed: _extends({}, Object(__WEBPACK_IMPORTED_MODULE_1_vuex__["b" /* mapGetters */])(['staffs', 'school'])),
    watch: {
        $route: function $route(route) {
            _this.params = route.query ? { category: route.query.t } : null;
            __WEBPACK_IMPORTED_MODULE_2__store_store__["a" /* default */].dispatch('staffs', { id: route.params.id, params: _this.params });
        },
        'staffs.length': function staffsLength(val) {
            this.loading = false;
        }
    },
    created: function created() {
    ...
    methods: {
        deleteRecord: function deleteRecord(id) {
            ...
            if (confirm('Deleting this item will remove all it\'s related data! Are you sure you want to proceed?')) {
                this.$store.dispatch('deleteStaffs', { ids: [id] }).then(function () {
                    _this2.successMsg('Selected data has been removed!', 'Success');
                }).catch(function () {
                    _this2.errorMsg('Error occurred: unable to delete item', 'Error');
                });
            }
        },
        exportExcel: function exportExcel() {
            ...
            dummy.download = 'staffs-' + this.school.name.toLowerCase().replace(/ /g, '-') + '-' + d.getFullYear() + '-' + (d.getMonth() + 1) + '-' + d.getDate() + '-' + d.getHours() + '-' + d.getMinutes() + '-' + d.getSeconds() + '.xls';
            dummy.click();
        },
        renderTable: function renderTable() {
            var table = '<table><thead>' + '<tr>' + '<th>ID</th>' + '<th>LAST NAME</th>' + '<th>MIDDLE NAME</th>' + '<th>FIRST NAME</th>' + '<th>SEX</th>' + '<th>PHONE</th>' + '</tr></thead>';
            table += '<tbody>';
      ...
      [
        ...
        _c(
          "b-card",
          {
            ...
            attrs: { header: "List of Staffs", "header-tag": "h4" }
          },
          [
            _vm.loading
              ? _c(
                      ...
                      scopedSlots: _vm._u([
                        {
                          key: "id",
                          fn: function(staff) {
                            return _c("span", {}, [_vm._v(_vm._s(staff.index))])
                          }
                        },
                        {
                          key: "Name",
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-4f40439d", module.exports)
  }
}
...
var __vue_styles__ = injectStyle
/* scopeId */
var __vue_scopeId__ = "data-v-4f40439d"
/* moduleIdentifier (server only) */
var __vue_module_identifier__ = null
var Component = normalizeComponent(
  __vue_script__,
...
Component.options.__file = "src/components/pages/staff/staffs.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-4f40439d", Component.options)
  } else {
    hotAPI.reload("data-v-4f40439d", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
