...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(32)("31e026bf", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../../node_modules/css-loader/index.js!../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-7b64a144\",\"scoped\":true,\"hasInlineConfig\":true}!../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./update.vue", function() {
     var newContent = require("!!../../../../node_modules/css-loader/index.js!../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-7b64a144\",\"scoped\":true,\"hasInlineConfig\":true}!../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./update.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
...
// module
exports.push([module.i, "\n.dz-progress[data-v-7b64a144] {\n    background-color: #08aa80 !important;\n}\n.red[data-v-7b64a144] {\n    color: red;\n    font-weight: bold;\n}\n.green[data-v-7b64a144] {\n    color: darkgreen;\n    font-weight: bold;\n}\n", ""]);
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(32)("3b55273c", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../css-loader/index.js!../../vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-7b64a144\",\"scoped\":false,\"hasInlineConfig\":true}!./vue-multiselect.min.css", function() {
     var newContent = require("!!../../css-loader/index.js!../../vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-7b64a144\",\"scoped\":false,\"hasInlineConfig\":true}!./vue-multiselect.min.css");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_vue2_dropzone_dist_vue2Dropzone_css__ = __webpack_require__(1238);
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    data: function data() {
        ...
        return _ref = {
            ...
            school: ''
        }, _defineProperty(_ref, 'lgas', []), _defineProperty(_ref, 'schools', []), _defineProperty(_ref, 'classes', []), _defineProperty(_ref, 'subjects', []), _defineProperty(_ref, 'filter', ''), _defineProperty(_ref, 'data', {
            subject_id: '',
            attendance: [{
                id: '',
          ...
          _c("b-card", [
            _c("div", { staticClass: "row" }, [
              ...
              _c(
                ...
                { staticClass: "col-lg-6" },
                [
                  _c("label", [_vm._v("Schools")]),
                  _vm._v(" "),
                  _c("multiselect", {
                    attrs: { "show-labels": false, options: _vm.schools },
                    model: {
                      value: _vm.school,
                      callback: function($$v) {
                        _vm.school = $$v
              ...
              _c("div", { staticClass: "col-12 col-md-4" }, [
                ...
                _c(
                  ...
                  [
                    ...
                    _vm._v(" "),
                    _c("option", { attrs: { value: "" } }, [_vm._v("First")]),
                    _vm._v(" "),
                    _c("option", { attrs: { value: "" } }, [_vm._v("Second")]),
                    _vm._v(" "),
                    _c("option", { attrs: { value: "" } }, [_vm._v("Third")])
                  ]
                )
              ]),
              _vm._v(" "),
              ...
              _c("div", { staticClass: "col-12 col-md-4" }, [
                ...
                _c(
                  ...
                  [
                    ...
                    _vm._v(" "),
                    _c("option", { attrs: { value: "0" } }, [_vm._v("weekly")]),
                    _vm._v(" "),
                    _c("option", { attrs: { value: "1" } }, [
                      _vm._v("Monthly")
                    ]),
                    _vm._v(" "),
                    _c("option", { attrs: { value: "2" } }, [_vm._v("Termly")])
                  ]
                )
              ])
            ]),
                ...
                _c("div", { staticClass: "table-responsive" }, [
                  _c(
                    ...
                    [
                      ...
                      _c(
                        "tbody",
                        _vm._l(_vm.data.attendance, function(student) {
                          return _c("tr", { attrs: { value: student.id } }, [
                                ...
                                directives: [
                                  {
                                    ...
                                    rawName: "v-model",
                                    value: student.mon,
                                    expression: "student.mon"
                                  }
                                ],
                                staticClass: "form-control",
                                attrs: { type: "checkbox", value: "1" },
                                domProps: {
                                  checked: Array.isArray(student.mon)
                                    ? _vm._i(student.mon, "1") > -1
                                    : student.mon
                                },
                                on: {
                                  change: function($event) {
                                ...
                                directives: [
                                  {
                                    ...
                                    rawName: "v-model",
                                    value: student.tue,
                                    expression: "student.tue"
                                  }
                                ],
                                staticClass: "form-control",
                                attrs: { type: "checkbox", value: "1" },
                                domProps: {
                                  checked: Array.isArray(student.tue)
                                    ? _vm._i(student.tue, "1") > -1
                                    : student.tue
                                },
                                on: {
                                  change: function($event) {
                                ...
                                directives: [
                                  {
                                    ...
                                    rawName: "v-model",
                                    value: student.wed,
                                    expression: "student.wed"
                                  }
                                ],
                                staticClass: "form-control",
                                attrs: { type: "checkbox", value: "1" },
                                domProps: {
                                  checked: Array.isArray(student.wed)
                                    ? _vm._i(student.wed, "1") > -1
                                    : student.wed
                                },
                                on: {
                                  change: function($event) {
                                ...
                                directives: [
                                  {
                                    ...
                                    rawName: "v-model",
                                    value: student.thur,
                                    expression: "student.thur"
                                  }
                                ],
                                staticClass: "form-control",
                                attrs: { type: "checkbox", value: "1" },
                                domProps: {
                                  checked: Array.isArray(student.thur)
                                    ? _vm._i(student.thur, "1") > -1
                                    : student.thur
                                },
                                on: {
                                  change: function($event) {
                                ...
                                directives: [
                                  {
                                    ...
                                    rawName: "v-model",
                                    value: student.fri,
                                    expression: "student.fri"
                                  }
                                ],
                                staticClass: "form-control",
                                attrs: { type: "checkbox", value: "1" },
                                domProps: {
                                  checked: Array.isArray(student.fri)
                                    ? _vm._i(student.fri, "1") > -1
                                    : student.fri
                                },
                                on: {
                                  change: function($event) {
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-7b64a144", module.exports)
  }
}
...
/* scopeId */
var __vue_scopeId__ = "data-v-7b64a144"
...
Component.options.__file = "src/components/pages/attendance/update.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-7b64a144", Component.options)
  } else {
    hotAPI.reload("data-v-7b64a144", Component.options)
  }
