...
var update = __webpack_require__(36)("3ff68984", content, false, {});
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(36)("aedfa6ce", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(36)("25b2d92c", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../../node_modules/css-loader/index.js!../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-d613a070\",\"scoped\":false,\"hasInlineConfig\":true}!../../../../node_modules/sass-loader/lib/loader.js!../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=2!./overview.vue", function() {
     var newContent = require("!!../../../../node_modules/css-loader/index.js!../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-d613a070\",\"scoped\":false,\"hasInlineConfig\":true}!../../../../node_modules/sass-loader/lib/loader.js!../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=2!./overview.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(36)("680fafae", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7_v_chartist__ = __webpack_require__(784);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7_v_chartist___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_7_v_chartist__);
//
//
//
//
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    components: {
        ...
        VueChartist: __WEBPACK_IMPORTED_MODULE_7_v_chartist___default.a
    },
    data: function data() {
        return {
            serverdata: [],
    ...
    mounted: function mounted() {
        ...
        this.$student.getStudentsPerLga().then(function (data) {
            _this.studentPerLgas = data;
    ...
    methods: {
        getMale: function getMale(maleStudentsPerLga) {
            this.totalMale = this.totalMale + 2;
            return maleStudentsPerLga;
        },
        getFemale: function getFemale(femaleStudentsPerLga) {
            this.totalFemale += parseInt(femaleStudentsPerLga);
            return femaleStudentsPerLga;
        },
        getTotal: function getTotal(studentsTotalPerLga) {
      ...
      _c(
        ...
        [
          _c(
            "b-card",
            {
              staticClass: "bg-primary-card bg-header-card",
              attrs: {
              ...
              _c("div", { staticClass: "table-responsive" }, [
                _c(
                  ...
                  [
                    ...
                    _c(
                      "tbody",
                      _vm._l(_vm.studentPerLgas, function(
                        studentPerLga,
                        index
                      ) {
                        return _c("tr", { key: index }, [
                          _c("td", [_vm._v(_vm._s(studentPerLga.name))]),
                          _vm._v(" "),
                          _c("td", [
                            _vm._v(
                              _vm._s(
                                _vm.getFemale(studentPerLga.students.female)
                              )
                            )
                          ]),
                          _vm._v(" "),
                          _c("td", [
                            _vm._v(
                              _vm._s(_vm.getMale(studentPerLga.students.male))
                            )
                          ]),
                          _vm._v(" "),
                          _c("td", [
                            _vm._v(
                              _vm._s(
                                _vm.getTotal(
                                  parseInt(studentPerLga.students.female) +
                                    parseInt(studentPerLga.students.male)
                                )
                              )
                            )
                          ])
                    ...
                    _c("tfoot", [
                      _c("tr", [
                        ...
                        _vm._v(" "),
                        _c("th", [_vm._v(_vm._s(_vm.totalStudents))])
                      ])
                    ])
                  ]
                )
...
var staticRenderFns = [
  ...
  function() {
    ...
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("div", { staticClass: "col-lg-3 col-md-6 mb-3" }, [
      _c(
        "div",
        { staticClass: "text-center p-3 widget_social_icons box_shadow" },
        [
          ...
          _vm._v(" "),
          _c("div", { staticClass: "text-ash" }, [
            _c("h4", { staticClass: "mb-0 mt-2 text_size" }, [_vm._v("742+")]),
            _vm._v(" "),
    ...
    return _c("div", { staticClass: "col-lg-3  col-md-6 mb-3" }, [
      _c(
        ...
        [
          ...
          _vm._v(" "),
          _c("div", { staticClass: "text-ash" }, [
            _c("h4", { staticClass: "mb-0 mt-2 text_size" }, [_vm._v("465+")]),
            _vm._v(" "),
