...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(32)("1d214796", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__dashboard_mixins__ = __webpack_require__(1241);
//
//
//
//
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    mixins: [__WEBPACK_IMPORTED_MODULE_0__dashboard_mixins__["a" /* Reports */]]
});
                  ...
                  [
                    _c(
                      "b-btn",
                      {
                        ...
                        attrs: { block: "", href: "#", variant: "default" }
                      },
                      [
                        _vm._v(
                          "\n                            School\n                        "
                    ...
                    _c("b-card-body", [
                      _c("div", { staticClass: "row" }, [
                        _c(
                          ...
                          [
                            _c("piechart", {
                              attrs: { iData: _vm.private_school }
                            })
                          ],
                          1
                        ),
                        ...
                        _c(
                          ...
                          [
                            _c("piechart", {
                              attrs: { iData: _vm.primary_school }
                            })
                          ],
                          1
                        ),
                        ...
                        _c(
                          ...
                          [
                            _c("piechart", {
                              attrs: { iData: _vm.secondary_school }
                            })
                          ],
                          1
                        ),
                        ...
                        _c(
                          ...
                          [
                            _c("donut", {
                              attrs: { iData: _vm.secondary_school_student }
                            })
                          ],
                          1
                        ),
                        ...
                        _c(
                          ...
                          [
                            _c("donut", {
                              attrs: { iData: _vm.primary_school_student }
                            })
                          ],
                          1
                        ),
                    ...
                    _c("b-card-body", [
                      _c("div", { staticClass: "row" }, [
                        _c(
                          ...
                          [
                            _c("piechart", {
                              attrs: { iData: _vm.staff_category_compare }
                            })
                          ],
                          1
                        ),
                        ...
                        _c(
                          ...
                          [
                            _c("stackbar", {
                              attrs: { iData: _vm.staff_gender_distribution }
                            })
                          ],
                          1
                        ),
                        ...
                        _c(
                          ...
                          [
                            _c("piechart", {
                              attrs: { iData: _vm.staff_gender_compare }
                            })
                          ],
                          1
                        ),
