...
var update = __webpack_require__(36)("0e2a5cf3", content, false, {});
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(36)("500d6d40", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_vue_multiselect__ = __webpack_require__(792);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_vue_multiselect___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_vue_multiselect__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__packages_resources__ = __webpack_require__(118);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__packages_resources___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1__packages_resources__);
//
//
//
//
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        ...
        getSchool: function getSchool() {
            ...
            this.$lga.getLgasSchool(114).then(function (data) {
                _this.schools = [];
                _this.schoolIds = [];
                _this.school = '';
                data.data.forEach(function (item) {
                    _this.schools.push(item.school_name);
                    _this.schoolIds.push({
                        id: item.id,
