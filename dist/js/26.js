...
var update = __webpack_require__(36)("72e773a5", content, false, {});
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_vue_form__ = __webpack_require__(998);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_src_validations_validations_js__ = __webpack_require__(778);
//
//
//
//
    ...
    methods: {
        onSubmit: function onSubmit() {
            ...
            if (this.formstate.$invalid) {
                ...
                this.$auth.login(credentials).then(function (data) {
                    console.log(data);
                    var redirect = _this.$route.query.redirect || "/";
                    console.log(redirect);
                    _this.$router.push(redirect);
                }).catch(function (response) {
                    _this.error = "The user credentials were incorrect.";
                });
            }
        }
    },
                                ...
                                on: {
                                  change: function($event) {
                                    ...
                                    if (Array.isArray($$a)) {
                                      ...
                                      if ($$el.checked) {
                                        $$i < 0 &&
                                          (_vm.model.remember = $$a.concat([
                                            $$v
                                          ]))
                                      } else {
                                        $$i > -1 &&
                                          (_vm.model.remember = $$a
                                            .slice(0, $$i)
                                            .concat($$a.slice($$i + 1)))
                                      }
                                    } else {
...
/* template */
var __vue_template__ = __webpack_require__(1466)
/* template functional */
